...
If you want the visualization dashboard, run:
...
Note: the hackathon submission is deployed as the OpenEnv server, not the Gradio dashboard.
...
- the Space should expose the OpenEnv HTTP server for validation
